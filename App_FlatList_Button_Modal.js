...
const App = () => {
  const [listItems, setListItems] = useState(hoas);
  const [showModal, setShowModal] = useState(false);
  const[hoachon,chon]=useState({
    "mahoa": 1,
    "tenloai": "Hoa Quà tặng",
    "tenhoa": "Đón xuân",
    "dongia": 15000,
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      selectedValue={Loaihoa}
          ...
          <Picker.Item label="Hoa Quà tặng" value="Hoa Quà tặng" />
          <Picker.Item label="Hoa Cưới" value="Hoa Cưới" />
          <Picker.Item label="Hoa Hồng" value="Hoa Hồng" />
          <Picker.Item label="Hoa Xuân" value="arHoa Xuâne" />
